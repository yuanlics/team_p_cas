...
class Payment():
    ...
    def update_warehouse(self, w_id, new_w_ytd):
        self.sess.execute(self.pre_update_warehouse.bind((new_w_ytd, w_id)))
    ...
    def update_district(self, w_id, d_id, new_d_ytd):
        self.sess.execute(self.pre_update_district.bind((new_d_ytd, w_id, d_id)))
    ...
    def update_customer(self, w_id, d_id, c_id, new_c_balance, new_c_ytd_payment, new_c_payment_cnt):
        self.sess.execute(self.pre_update_customer.bind((new_c_balance, new_c_ytd_payment, new_c_payment_cnt, w_id, d_id, c_id)))    
